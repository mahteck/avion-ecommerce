...
const About = () => {
    return (
        <div>
            ...
            {/* Story Section */}
            <div className="flex flex-col md:flex-row items-center justify-between w-full px-6 py-12 bg-white gap-2">
                {/* Left Section */}
                <div
                    className="w-full md:w-1/2 bg-[#2A254B] text-white p-8 md:p-12 flex flex-col justify-between"
                    style={{ minHeight: "480px" }}
                >
                    <div>
                        <h1 className="text-xl md:text-2xl font-bold">It started with a small idea</h1>
                        <p className="mt-4 text-sm md:text-base leading-relaxed">
                            A global brand with local beginnings, our story began in a small studio in South London in early 2014.
                        </p>
                    </div>
                    <div className="mt-6">
                        <button className="bg-white text-[#2A254B] px-6 py-2 rounded hover:bg-opacity-80 transition-all">
                            View Collection
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 flex justify-center mt-6 md:mt-0">
                    <img
                        ...
                        alt="About main"
                        className="w-full h-auto max-w-[400px] md:max-w-full object-cover rounded-lg shadow-lg"
                    />
                </div>
            </div>
